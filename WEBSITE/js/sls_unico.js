                ...
                success: function (data){
                        ...
                        if(sls){
                            ...
                            for(i=0; i<sls.length; i++){
                                prodotticonsigliati+='<div class="container-fluid centrato corpo imm" ><img class="container-fluid centrato corpo imm" src="'+sls[i].FOTO+'" alt=""><br> <a href="prodottoUnico.html?codice='+sls[i].PRODOTTO+'">'+sls[i].NOMEPR+'</a></div>';
                            }
