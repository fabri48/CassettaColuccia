...
  return variabili;
    ...
    $.ajax({
                ...
                success: function (data){
                        ...
                        var el="";
                        var scroll='<ul class="nav nav-pills nav-stacked affix" data-spy="affix" data-offset-top="0">';
                        ...
                        if(tariffe){
                            ...
                            for(var i=0; i<tariffe.length; i++){
                                ...
                                el+='<div class="container centrato contenitore" id="contenitore'+index+'"><p>'+tariffe[i].NOME+'</p>';
                                if(tariffe[i].MENU==0){
                                    scroll+='<li class=" lista"><a href="#contenitore'+index+'">'+tariffe[i].NOME+'</a></li>';
                                }
                                if(tariffe[i].CHIAMATE){
                                    ...
                                    if(tariffe[i].ALTRO){
                                        el+='<div class="container-fluid centrato corpo spazio"><table><tbody><tr><td><img     src="'+imgaltro+'" alt=""></td></tr><tr><td style="width:100%;">'+tariffe[i].ALTRO+'</td></tr></tbody></table></div>';
                                    }
