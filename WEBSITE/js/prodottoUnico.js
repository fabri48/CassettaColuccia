    ...
    var data=dati;
            ...
            $.ajax({
                ...
                success: function (data){
                        ...
                        tariffacons+='<tr><th id="titolotab" scope="col"><a class="cambio" href="tariffaUnica.html?id='+prodotto[0].ID+'">'+prodotto[0].NOME+'</a></th><br></tr>';
                        ...
                        tariffacons+='</table></tbody><br><a class="cambio" href="tariffe_consigliate.html?codice='+prodotto[0].CODICE+'">Altre tariffe consigliate</a>';
                            
                        slscons+='<desc>Servizio SmartLife consigliato:</desc><a class="cambio" href="slsUnico.html?codice='+prodotto[0].CODSLS+'"><img class="container-fluid span-5" id="slsconsigliato" src="'+prodotto[0].FOTOGRUPPO+'" alt="TIM MUSIC"></a><a class="cambio" href="sls_consigliati.html?codice='+prodotto[0].CODICE+'">Altri servizi consigliati </a>';
